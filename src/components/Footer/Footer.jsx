...
function Footer() {
  ...
  <ul className="space-y-2 ">
    <li>
      <Link to="/home" className="hover:text-blue-500 transition duration-200">
        Home
      </Link>
    </li>
    <li>
      <Link to="/airnub" className="hover:text-blue-500 transition duration-200">
        Create Listing
      </Link>
    </li>
    <li>
    ...
    <li>
      <Link to="/signin" className="hover:text-blue-500 transition duration-200">
        Sign In
      </Link>
    </li>
  </ul>
